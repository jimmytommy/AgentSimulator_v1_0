...
namespace SharpNeatLib.CPPNs
{
    public class SubstrateDescription
    {
        ...
        private List<PointF> transNeurons;
        private List<PointF> receiveNeurons;
        ...
        public uint TransCount { get; set; }
        ...
        private void updateNeuronCounts()
        {
            ...
            foreach (NeuronGroup ng in neuronGroups)
            {
                switch (ng.GroupType)
                {
                    case 4: TransCount += ng.DX * ng.DY; break;
                    case 3: ReceiveCount += ng.DX * ng.DY; break;
        ...
        //TODO - enable transit and receive node types for homogenous genomes
        ...
        public NeatGenome.NeatGenome generateMultiGenomeStack(INetwork network, uint numberOfAgents, bool normalizeWeights, bool adaptiveNetwork, bool modNetwork, out List<float> coords, bool evolvedSubstrate, bool dirComm)
        {
            //List<float>
            ...
            if (evolvedSubstrate)
            {
                ...
                return this.generateMultiGenomeStack(network, coords, normalizeWeights, adaptiveNetwork, modNetwork, dirComm);
        }
