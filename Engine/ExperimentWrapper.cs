...
namespace Engine
{
    public class ExperimentWrapper
    {
        [
            ...
            System.Xml.Serialization.XmlElement(typeof(FlockingExperiment)),
            System.Xml.Serialization.XmlElement(typeof(PreyExperiment)),
            System.Xml.Serialization.XmlElement(typeof(ModularExperiment))
        ] 
